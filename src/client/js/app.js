...
const updateUI = async () => {
    ...
    document.getElementById('result-div').innerHTML = `<p>${endPoint['city']}, ${endPoint['countryName']} is ${endPoint['diffDays']} days away.</p><p>Typical weather for then is:\nTemperature: ${endPoint['temp']}\n${endPoint['description']}</p>`
}
...
export{handleSubmit,removeTrip,setDateStartLimit, endPoint}
